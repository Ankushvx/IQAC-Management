...
class HttpUtils {
  ...
  static Future<ApiResponse?> postRequest({required String url, Map<String, dynamic>? body, Map<String, dynamic>? queryParameters}) async {
    try {
  ...
  static Future<ApiResponse?> getRequest({required String url, Map<String, dynamic>? queryParameters}) async {
    try {
